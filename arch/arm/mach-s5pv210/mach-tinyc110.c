...
static struct resource tinyc110_dm9000_resources[] = {
	[0] = {
...
static struct dm9000_plat_data tinyc110_dm9000_platdata = {
	.flags		= DM9000_PLATF_16BITONLY | DM9000_PLATF_NO_EEPROM,
	.dev_addr	= { 0x08, 0x90, 0x00, 0xa0, 0x01, 0x10 },
};

struct platform_device tinyc110_dm9000 = {
	.name		= "dm9000",
	.id			= -1,
	.num_resources	= ARRAY_SIZE(tinyc110_dm9000_resources),
	.resource	= tinyc110_dm9000_resources,
	.dev		= {
		.platform_data	= &tinyc110_dm9000_platdata,
	},
};
#endif

#if defined(CONFIG_RFKILL_GPIO)
#include <linux/rfkill-gpio.h>
static void __init ap6212_bt_setup(void)
{
	/* 4 UART Pins configuration */
	s3c_gpio_cfgrange_pullup(S5PV210_GPA0(4), 4, S3C_GPIO_SFN(2));
}

/* Bluetooth rfkill gpio platform data */
struct rfkill_gpio_platform_data ap6212_bt_pdata = {
	.reset_gpio	= S5PV210_GPJ3(5),
	.shutdown_gpio	= -1,
...
static struct platform_device ap6212_device_bluetooth = {
	.name		= "rfkill_gpio",
	.id		= -1,
	.dev		= {
		.platform_data	= &ap6212_bt_pdata,
	},
};
#endif
...
static struct platform_device *mini210_devices[] __initdata = {
	...
	&s5p_device_hpd,
#endif
#ifdef CONFIG_RFKILL_GPIO
	&ap6212_device_bluetooth,
#endif
};
...
{
	/* Attention:
	* TinyC110 has a SD WiFi(Marvell8686)
	* Core-C100 has a SD WiFi(AP6212)
	*/
...
static int __init dm9000_set_mac(char *str) {
	...
	if (idx == 6) {
		...
		memcpy(tinyc110_dm9000_platdata.param_addr, addr, 6);
	}
...
static void __init tinyc110_dm9000_init(void)
{
	unsigned int tmp;
...
static void __init mini210_machine_init(void)
{
	...
	s3c_i2c0_set_platdata(NULL /* &i2c0_data */);
...
MACHINE_START(TINYC110, "TINYC110")
